...
from model import GPTConfig, GPT, CausalSelfAttention, CausalSelfAttentionMerged, CausalSelfAttentionShifted, CausalSelfAttentionMergeLinear, CausalSelfAttentionMergedHierarchy  
...
data_dir = os.path.join('/work1/sawmya/czhang/6.4610/Multi-resolution-Attention/nanogpt/data', dataset)
def get_batch(split):
